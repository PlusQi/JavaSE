...
public class Demo02OutputStream {
    public static void main(String[] args) throws IOException {
        ...
        FileOutputStream fos = new FileOutputStream(new File("D:\\Documents\\Desktop\\b.txt"));
        ...
        * public void write(byte[] b): 将b.length字节从指定的字节数组写入此输出流
        * 一次写多个字节：
        *   如果写的第一个字节是正数(1-127),那么显示的时候会查询ASCII表
        *   如果写的第一个字节是负数，那第一个字节会和第二个字节，两个字节组成要给中文显示查询系统默认编码表(GBK)
        * */
