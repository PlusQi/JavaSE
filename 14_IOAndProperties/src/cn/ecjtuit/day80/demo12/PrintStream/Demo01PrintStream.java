package cn.ecjtuit.day80.demo12.PrintStream;
...
* PrintStream特点：
*   1.只负责数据的输出，不负责数据的读取
*   2.与其他输出流不同，PrintStream 永远不会哈派出 IOException
...
*   PrintStream(String fileName): 输出目的地是要给文件路径
...
public class Demo01PrintStream {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        PrintStream ps = new PrintStream("D:\\Documents\\DeskTop\\print.txt");
